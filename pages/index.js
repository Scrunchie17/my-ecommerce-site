...
const products = [
  { id: 1, name: "T-Shirt", category: "Clothing", price: 19.99, image: "/images/t-shirt.jpeg" },
  { id: 2, name: "Jeans", category: "Clothing", price: 59.99, image: "/images/jeans.jpeg" },
  { id: 3, name: "Laptop", category: "Electronics", price: 1999.99, image: "/images/laptop.jpeg" },
  { id: 4, name: "Smartphone", category: "Electronics", price: 999.99, image: "/images/phone.jpeg" },
  { id: 5, name: "Bread", category: "Groceries", price: 3.99, image: "/images/bread.jpeg" },
  { id: 6, name: "Milk", category: "Groceries", price: 2.49, image: "/images/milk.jpeg" },
];
      ...
      <header className="bg-gray-800 shadow">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Button className="text-gray-100 border-gray-100">
